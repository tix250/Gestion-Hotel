...
<%
	...
	String mot_clef = (String) request.getAttribute("mot_clef");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="jumbotron jumbotron-fluid">
	  <div class="container">
	    <h1 class="display-4">Resultat(s) de la recherche.</h1>
	    <p class="lead">Cette page est dedie pour voir les resultats sur la barre de recherche.</p>
	  </div>
	</div>
	...
	<nav aria-label="...">
	  ...
	  <% for (int i = 0 ; i != nbrPage ; i++) { %>
	    <li class="page-item"><a class="page-link" href="Recherche?pageNumber=<% out.print(i+1); %>&mot_clef=<%out.print(mot_clef); %>"><% out.println(i+1); %></a></li>
	  <%} %>
	  </ul>
	</nav>
	<br><br><br> 
